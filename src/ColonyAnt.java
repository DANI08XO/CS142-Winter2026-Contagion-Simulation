...
public class ColonyAnt extends Ant {
    ...
    protected ColonyAnt(WorldGrid world, Random rng, Point pos, int maxEnergy, Point home) {
        super(world, rng, pos, maxEnergy);
        if (home == null) throw new IllegalArgumentException("home");
        this.home = home;
    }

    public final Point getHome() {
        return home;
    }

    public final Point getFoodStore() {
        return foodStore;
    }

    public final void setFoodStore(Point foodStore) {
        this.foodStore = foodStore;
    }

    public Direction returnHome() {
